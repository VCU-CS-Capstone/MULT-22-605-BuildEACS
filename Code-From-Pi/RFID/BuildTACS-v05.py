    ...
    with open('/home/pi/Desktop/RFID/Log/log-table_saw.csv', 'r') as user:
        ...
        for row in csv_reader:
            if line_count == 0:
                last_rfid = row[2]
                line_count += 1
        if last_rfid != rfid_number:
            log_file = open('/home/pi/Desktop/RFID/members_list', 'r') #change for type of machine in use
            new_line = (last_rfid + ',' + 'placeholder_last' + ',' + 'placeholder_first' ',' + 'nickname' + ',' + 'table_saw' + ', \n')
            contents = log_file.readlines()
            contents.insert(0, new_line)
            log_file.close()
            log_file = open('/home/pi/Desktop/RFID/members_list', 'w') #change for type of machine in use
            ...
            print(last_rfid + ' was just certified')
...
with open('/home/pi/Desktop/RFID/members_list') as whitelist:
    ...
    for row in csv_reader:
        ...
        member_type_list.append(member_type)
        unlimited_power_list.append(unlimited_power)
        print('Machine Access Control System ... Booting up')
...
board.digital[red].write(0)
board.digital[green].write(0)
print('Machine Access Control System ... Ready')
while True:
    ### Wait for RFID
    ...
    if ID_list.count(rfid_number) > 0: #Define what a member is
        ...
        if unlimited_power_list[pos] == 'manager' > 0:
            manager_fob()
